...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 py-16 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="mb-8 text-gray-700">
              ...
              no dudes en escribirnos usando el formulario.
            </p>
              ...
              {contactInfo.map((c, idx) => {
                ...
                return (
                  <a
                    key={idx}
                    href={c.link}
                    className="flex items-center gap-4 p-4 rounded-xl bg-linear-to-r from-blue-50 to-purple-50 hover:shadow-md transition-all duration-200 group"
                  >
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
